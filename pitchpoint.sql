...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 08:06 PM
...
(30, 1, 'Logged in', 'Success', '2025-12-04 17:54:39'),
(31, 1, 'Logged out', 'Success', '2025-12-04 17:58:14');
...
(1, 'Rafia Tasnim', 'rafia@pitchpoint.com', '$2y$10$Mn7T8jnozDpcpF1DhiwM/uZbuGOspX7UATHNypvQHo9j/5N5xa4p6', 1, '2025-12-04 17:54:39');
...
(3, 33, 'humvalala company', 'https://humvalala.com', 'Sylhet', '2025-12-04 18:48:14', '2025-12-04 18:55:59');
...
(14, 5, 17, 20.00, 'card', '2025-12-04 18:06:53');
...
(4, 2, 31, 2, 'Zahid bombaclat', 0, '2025-12-04 18:13:35'),
(5, 20, 16, 33, 'Mwah yeobo', 0, '2025-12-04 18:52:32');
...
(19, 1, 'Big Brain', 'Big brain moment', 'When the brain is small, it makes it big.', 'Expands the brain', 7, 32000.00, 'idea', 'published', 'public', '2025-12-04 18:20:02', '2025-12-04 18:34:36'),
(20, 3, 'Biriyani', 'Biriyani good', 'Cant find biriyani when hungry', 'Buy biriyani', NULL, 129.00, 'idea', 'published', 'public', '2025-12-04 18:51:28', '2025-12-04 18:51:28');
...
(24, 19, 'download (1).jpeg', 'uploads/cover_image_6931c2c242e191.95631906.jpeg', 'image/jpeg', 44351, 32, '2025-12-04 18:20:02'),
(25, 20, 'WhatsApp Image 2025-03-19 at 13.17.44_39afc10f.jpg', 'uploads/cover_image_6931ca20165413.78437921.jpg', 'image/jpeg', 13606, 33, '2025-12-04 18:51:28');
...
(8, 17, 5, NULL, '2025-12-04 18:08:00'),
(11, 15, 5, NULL, '2025-12-04 18:10:47'),
(13, 14, 5, NULL, '2025-12-04 18:11:47'),
(14, 2, 5, NULL, '2025-12-04 18:12:34');
...
(24, 14, 17, 20.00, 'succeeded', '2025-12-04 18:06:53');
...
(28, 'jaa juu', 'jaj@gam.com', '$2y$10$7UZjTUz3EZT6vYcTnZ8SXea7h8qAFhUCHrIrilcndKUWLSsnG/5HK', NULL, 'investor', 1, '2025-12-04 14:32:39', '2025-12-04 14:32:47', 1, NULL),
(29, 'okk', 'olh@kl.nm', '$2y$10$FR6VplOuPs/Th51Ko4tfWOvr5laH/.8beKSBkvgFCNtEmVKwMWRzi', NULL, 'investor', 1, '2025-12-04 15:11:44', '2025-12-04 15:11:52', 1, NULL),
(30, 'zagg k', 'zagg@jk.cv', '$2y$10$TwQyr9ygFPyIZbBPD57wpuJ3Y/qcEuCjNLskwhjWKjACSHW.xl18C', NULL, 'entrepreneur', 1, '2025-12-04 15:14:19', '2025-12-04 15:14:26', 1, NULL),
(31, 'muntaha', 'muntaha@gmail.com', '$2y$10$BS6uVl9p8HDkkE60nIj4cuwrkWDaY/KNCDuSb7myzvJuS6frQssDK', NULL, 'investor', 1, '2025-12-04 18:02:17', '2025-12-04 18:02:26', 1, NULL),
(32, 'zahid bombaclat', 'zahid@gmail.com', '$2y$10$BZ/nXDT1Q7Z.dL6or3Tjme/jBysUfR1DiM.9G.Z3WyGPw8sxvrjz2', NULL, 'entrepreneur', 1, '2025-12-04 18:15:17', '2025-12-04 18:15:25', 1, NULL),
(33, 'Shafi Chowdhury', 'shafi@gmail.com', '$2y$10$AkJFQ.gOlCGw8hnLoJIGwO1Er2uha9HmcJ7Km7C40xXg3PPqCQ94S', NULL, 'entrepreneur', 1, '2025-12-04 18:48:14', '2025-12-04 18:56:35', 1, NULL);
...
--
ALTER TABLE `activity_log`
  MODIFY `log_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `entrepreneurs`
  MODIFY `entrepreneur_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `investments`
  MODIFY `investment_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `investors`
--
ALTER TABLE `investors`
  MODIFY `investor_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `project_files`
  MODIFY `file_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `project_interests`
--
ALTER TABLE `project_interests`
  MODIFY `interest_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
